...
/*class AppOld extends React.Component {
    constructor(props) {
        ...
        handleForward = handleForward.bind(this);
        handleBaseChange = handleBaseChange.bind(this);
    }
...
/*
class ControlsOld extends React.Component {
    constructor(props) {
        super(props);
        handleForward = handleForward.bind(this);
        handleBaseChange = handleBaseChange.bind(this);
...
/*
class LogOld extends React.Component {
    render() {
        let log = null;
        let placeholder = (<tr><td colSpan={3}>No results yet</td></tr>);
        ...
        return (
            <div className="py-3">
                ...
                <table className="table table-striped table-bordered table-dark table-responsive align-middle">
                    ...
                    <tbody>
                        {props.log.length > 0 ? log : placeholder}
                    </tbody>
                </table>
            </div>
        );
...
/*
class VariablesOld extends React.Component {
    render() {
        if (props.variables) {
            const memory = groupBy(props.memory, "variable", "value");
...
/*
class VariableInputOld extends React.Component {
    render() {
        if (props.values) {
            const options = props.values.map((value) => {
                return (
...
/*
class KnowledgeBaseOld extends React.Component {
    render() {
        let rules = null;
        if (props.rules) {
            rules = props.rules.map((rule) => {
