...
const Log = (props) => {
        ...
        log = props.log.map(step => {
            ...
            if (step["type"] === "target found") {
                ...
                return (
                    <tr>
                        <td>{stepId}</td>
                        <td colSpan={2}>No applicable rules!</td>
                    </tr>
                );
    ...
    return (
        <div>
            <div className="row">
            <h2 className="py-3 d-flex justify-content-center">Result: </h2>
    ...
    if (props.values) {
        ...
        return (
            ...
            <div className="form-floating">
                <select className="form-select " style={{ borderRadius: '40px', paddingLeft: '25px', border:'2px solid #218838ff'}} id={props.name + "-select"} aria-label="Floating label select example">
                    <option value=""></option>
                    {options}
                </select>
